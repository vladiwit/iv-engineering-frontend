const electric = {
  ...
  internalWork: [
    ...
    ' - organization (design, laying, installation, measurement) of grounding circuits',
    ' - system service support',
  ],
  vruTitle: 'Input and switchboards',
  vru: [
    '- we collect shields of different complexity and configuration for specific tasks',
    ' - we provide a guarantee, service',
    ' - we provide documentation',
    '- we modernize or change the existing equipment',
  ],
  ...
  thunder: [
    ...
    ' - installation',
    ' - checking the earthing circuits',
