const access = {
  ...
  linkTitle: 'СКУД з ідентифікацією по венозній сітці або аналогічні системи',
  ...
  details2: ['інші системи біометричної ідентифікації'],
  works: [
    'Разработка проектної документації',
    'вибір систем',
    'инсталляция и налагодження',
    'сервісна підтримка',
  ],
};
